...
def home():
    """
    Petite page d'accueil avec un bouton "Se connecter avec TikTok".
    Sert de point de départ pour tester (et filmer) le flow complet.
    """
    return """
    <html>
      <head>
      ...
      <body style="font-family: sans-serif; text-align: center; margin-top: 100px;">
        <h1>Wil App</h1>
        <p>Démo du flow de connexion TikTok</p>
